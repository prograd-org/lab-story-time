...
function moreAboutHome(address, distanceFromTown, hasNeighbours){
    ...
    var d=typeof(distanceFromTown);
    var h=typeof(hasNeighbours);
    var result = a+d+h;
    return result;
}
...
function consoleKaren(strategies){
    var strategy = "Take her daughter to a doctor"+" "+"Talk to her husband about it"+" "+"Counsel her daughter herself"+" "
