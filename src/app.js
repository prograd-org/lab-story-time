...
function sweetTooth(
  ...
  let sweetsRemaining = totalNoOfSweets - sweetsConsumedByKaren;
  sweetsRemaining -= [metersToTravel * sweetsConsumedInNMeters];

  if (sweetsRemaining > 0) {
    return sweetsRemaining / 2;
  }
  return 0;
}
