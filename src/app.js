...
function sweetTooth(totalNoOfSweets,sweetsConsumedByKaren,sweetsConsumedInNMeters,metersToTravel) {
  ...
  if (
    (((typeof totalNoOfSweets == typeof sweetsConsumedByKaren) == typeof sweetsConsumedInNMeters) ==
      typeof metersToTravel) == "number" ) {
    if (
      totalNoOfSweets + sweetsConsumedByKaren + sweetsConsumedInNMeters + metersToTravel == 0
    )
      return 0;
    else {
